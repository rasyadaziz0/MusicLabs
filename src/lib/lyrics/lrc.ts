import { LrcLine, LrcWord } from '@/types/utils/lrc';
...
export function vocalEnd(line: LrcLine, type: 'yrc' | 'lrc'): number {
...
export function makeDots(start: number, end: number): LrcLine {
  const d = end - start;
  return {
